...
checkinstall -D -y \
	...
	--provides=buho \
	--requires="mauikit-accounts-git \(\>= 4.0.1\),mauikit-filebrowsing-git \(\>= 4.0.1\),mauikit-git \(\>= 4.0.1\),mauikit-terminal-git \(\>= 4.0.1\),mauikit-texteditor-git \(\>= 4.0.1\),qml6-module-qtcore" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
